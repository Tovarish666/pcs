...
По шагам: спрашивает ссылку на таблицу (если её ещё нет) и запоминает → собирает шаблон ВМ модема `9999`, если его нет → создаёт по таблице все модемы и втыкает их в эту ВМ. Готовые модемы не трогает, так что команду можно повторять.
...
Плюс 206 локальных проверок на разбор таблицы, конфиги, режим показа и заглушки.
